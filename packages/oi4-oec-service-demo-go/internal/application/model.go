...
var parametersSensor = []sensor.IOLinkParameter{
	// --- Sensor ---
...
var parametersDeviceTemperature = []sensor.IOLinkParameter{
	// --- Device Temperature ---
...
var parametersUnitAndDamping = []sensor.IOLinkParameter{
	// --- Unit & Damping ---
...
var parametersDiagnostics = []sensor.IOLinkParameter{
	// --- Diagnostic System ---
...
var parametersCurrentOutput = []sensor.IOLinkParameter{
	// --- Current Output ---
